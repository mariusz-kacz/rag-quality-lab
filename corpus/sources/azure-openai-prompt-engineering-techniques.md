...
Source metadata:
- source_slug: azure-openai-prompt-engineering-techniques
- category: prompting techniques
- upstream_url: https://learn.microsoft.com/en-us/azure/foundry/openai/concepts/prompt-engineering
- source_markdown: https://github.com/MicrosoftDocs/azure-ai-docs/blob/main/articles/foundry/openai/includes/concepts-prompt-engineering-content.md
...
- snapshot_type: normalized copy of source markdown include
- normalization: removed YAML metadata/page chrome; converted Microsoft note markers; retained source prose, headings, tables, and compact examples
...
| Prompt | Completion|
|--------|-----------|
| Can you please tell me how to get to the museum?<br>Translate to French: |`Pouvez-vous s'il vous plait me dire comment aller au musee?` |
...
[Included SDK/example content omitted during snapshot normalization.]
## Best practices
